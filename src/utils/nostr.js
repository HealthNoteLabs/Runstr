...
export const fetchRunningPosts = async (limit = 10, since = undefined) => {
  ...
  const filter = {
    ...
    limit,
    "#t": ["Runstr", "Running", "run", "running", "runner", "5k", "10k", "marathon", "jog", "ultra", "trailrun", "trailrunning"],
    since: sinceTimestamp || Math.floor(Date.now() / 1000) - 90 * 24 * 60 * 60 // Last 90 days
  };
