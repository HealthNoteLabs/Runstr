...
import { convertDistance, formatPaceWithUnit, formatTime, formatElevation, formatPace, formatDate } from '../utils/formatters';
      ...
      {recentRun && !isTracking && (
        <div className="mx-4 mt-4 bg-gradient-to-br from-[#111827] to-[#1a222e] rounded-xl shadow-lg overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-800">
            <h3 className="text-lg font-semibold">Previous Run</h3>
          ...
          <div className="p-4">
            <div className="flex items-center">
              ...
              <div className="flex-1">
                <h4 className="font-semibold">Recent Run</h4>
